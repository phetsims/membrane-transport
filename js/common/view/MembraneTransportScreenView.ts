...
export default class MembraneTransportScreenView extends ScreenView {
  ...
  public constructor(
    ...
    // TODO: Move to another file? see https://github.com/phetsims/membrane-transport/issues/239
    // TODO: check against design, see https://github.com/phetsims/membrane-transport/issues/239
    this.model.membranePotentialProperty.lazyLink( ( membranePotential, oldMembranePotential ) => {
      const filledSlots = this.model.getFilledSlots();
      ...
      if ( response ) {
        this.addAccessibleResponse( response );
      }
    } );
  }
