...
export default class MacroCellNode extends Node {
  ...
  public constructor() {
    ...
    const point1Property = new Vector2Property( new Vector2( 6, 378 ) );
    const point2Property = new Vector2Property( new Vector2( 194, 406 ) );
    ...
    const shapeProperty = new Property( new Shape( 'M 6 378 L 194 378 Q 218.5 378.5 243 379 Q 400.5 374.5 558 370 C 800 408 1094 320 1080 502 Q 1051 793 948 891 Q 829 943 619 1020 Q -96 871 -95 706 Q -74 381 -6 378 Z' ) );
