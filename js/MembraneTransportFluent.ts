...
addToMapIfDefined( 'a11y_crossingInitialResponse', 'a11y.crossingInitialResponseStringProperty' );
addToMapIfDefined( 'a11y_crossingSubsequentResponse', 'a11y.crossingSubsequentResponseStringProperty' );
...
addToMapIfDefined( 'a11y_transportProtein_offMembrane', 'a11y.transportProtein.offMembraneStringProperty' );
...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    _comment_3: new FluentComment( {"comment":"Brevity is the soul of wit, so we use these brief names in various places.","associatedKey":"soluteBrief"} ),
    ...
    crossingInitialResponse: new FluentPattern<{ amount: 'none' | 'equal' | 'manyMoreOutside' | 'aboutTwiceAsManyOutside' | 'someMoreOutside' | 'roughlyEqualOutside' | 'manyMoreInside' | 'aboutTwiceAsManyInside' | 'someMoreInside' | 'roughlyEqualInside' | TReadOnlyProperty<'none' | 'equal' | 'manyMoreOutside' | 'aboutTwiceAsManyOutside' | 'someMoreOutside' | 'roughlyEqualOutside' | 'manyMoreInside' | 'aboutTwiceAsManyInside' | 'someMoreInside' | 'roughlyEqualInside'>, soluteType: 'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp' | TReadOnlyProperty<'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp'> }>( fluentSupport.bundleProperty, 'a11y_crossingInitialResponse', _.get( MembraneTransportStrings, 'a11y.crossingInitialResponseStringProperty' ), [{"name":"amount","variants":["none","equal","manyMoreOutside","aboutTwiceAsManyOutside","someMoreOutside","roughlyEqualOutside","manyMoreInside","aboutTwiceAsManyInside","someMoreInside","roughlyEqualInside"]},{"name":"soluteType","variants":["oxygen","carbonDioxide","sodiumIon","potassiumIon","glucose","atp"]}] ),
    crossingSubsequentResponse: new FluentPattern<{ amount: 'none' | 'equal' | 'manyMoreOutside' | 'aboutTwiceAsManyOutside' | 'someMoreOutside' | 'roughlyEqualOutside' | 'manyMoreInside' | 'aboutTwiceAsManyInside' | 'someMoreInside' | 'roughlyEqualInside' | TReadOnlyProperty<'none' | 'equal' | 'manyMoreOutside' | 'aboutTwiceAsManyOutside' | 'someMoreOutside' | 'roughlyEqualOutside' | 'manyMoreInside' | 'aboutTwiceAsManyInside' | 'someMoreInside' | 'roughlyEqualInside'>, soluteType: 'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp' | TReadOnlyProperty<'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp'> }>( fluentSupport.bundleProperty, 'a11y_crossingSubsequentResponse', _.get( MembraneTransportStrings, 'a11y.crossingSubsequentResponseStringProperty' ), [{"name":"amount","variants":["none","equal","manyMoreOutside","aboutTwiceAsManyOutside","someMoreOutside","roughlyEqualOutside","manyMoreInside","aboutTwiceAsManyInside","someMoreInside","roughlyEqualInside"]},{"name":"soluteType","variants":["oxygen","carbonDioxide","sodiumIon","potassiumIon","glucose","atp"]}] ),
    ligandToggleButton: {
    ...
    transportProtein: {
      ...
      offMembraneStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_transportProtein_offMembrane', _.get( MembraneTransportStrings, 'a11y.transportProtein.offMembraneStringProperty' ) ),
    ...
    _comment_4: new FluentComment( {"comment":"For the Membrane Potential radio buttons","associatedKey":"membranePotential"} ),
    _comment_5: new FluentComment( {"comment":"Membrane potential change responses for voltage-gated channels","associatedKey":"membranePotential"} ),
    membranePotential: {
