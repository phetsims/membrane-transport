...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    transportProtein: {
      ...
      accessibleParagraph: new FluentPattern<{ proteinType: 'sodiumIonLigandGatedChannel' | 'potassiumIonLigandGatedChannel' | number | 'other' | TReadOnlyProperty<'sodiumIonLigandGatedChannel' | 'potassiumIonLigandGatedChannel' | number | 'other'>, state: 'openToInsideEmpty' | 'openToInsideSodiumBound' | 'openToInsideSodiumAndATPBound' | 'openToInsideSodiumAndPhosphateBound' | 'openToOutsideAwaitingPotassium' | 'openToOutsidePotassiumBound' | 'openToOutsideAwaitingParticles' | 'openToOutsideAllParticlesBound' | 'openToInside' | 'ligandBoundClosed' | 'ligandBoundOpen' | 'ligandUnboundOpen' | 'open' | 'closed' | number | 'other' | 'closedNegative70mV' | 'openNegative50mV' | 'closed30mV' | 'closedNegative50mV' | 'open30mV' | TReadOnlyProperty<'openToInsideEmpty' | 'openToInsideSodiumBound' | 'openToInsideSodiumAndATPBound' | 'openToInsideSodiumAndPhosphateBound' | 'openToOutsideAwaitingPotassium' | 'openToOutsidePotassiumBound' | 'openToOutsideAwaitingParticles' | 'openToOutsideAllParticlesBound' | 'openToInside' | 'ligandBoundClosed' | 'ligandBoundOpen' | 'ligandUnboundOpen' | 'open' | 'closed' | number | 'other' | 'closedNegative70mV' | 'openNegative50mV' | 'closed30mV' | 'closedNegative50mV' | 'open30mV'> }>( fluentSupport.bundleProperty, 'a11y_transportProtein_accessibleParagraph', _.get( MembraneTransportStrings, 'a11y.transportProtein.accessibleParagraphStringProperty' ), [{"name":"proteinType","variants":["sodiumIonLigandGatedChannel","potassiumIonLigandGatedChannel",{"type":"number","value":"other"}]},{"name":"state","variants":["openToInsideEmpty","openToInsideSodiumBound","openToInsideSodiumAndATPBound","openToInsideSodiumAndPhosphateBound","openToOutsideAwaitingPotassium","openToOutsidePotassiumBound","openToOutsideAwaitingParticles","openToOutsideAllParticlesBound","openToInside","ligandBoundClosed","ligandBoundOpen","ligandUnboundOpen","open","closed",{"type":"number","value":"other"},"closedNegative70mV","openNegative50mV","closed30mV","closedNegative50mV","open30mV"]}] ),
