...
addToMapIfDefined( 'a11y_transportProtein_voicingHintResponseMouseInput', 'a11y.transportProtein.voicingHintResponseMouseInputStringProperty' );
...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    transportProtein: {
      ...
      voicingHintResponseMouseInputStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_transportProtein_voicingHintResponseMouseInput', _.get( MembraneTransportStrings, 'a11y.transportProtein.voicingHintResponseMouseInputStringProperty' ) ),
