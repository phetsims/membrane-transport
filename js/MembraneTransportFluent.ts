...
addToMapIfDefined( 'a11y_soluteConcentrationsAccordionBox_barChart_accessibleNameNone', 'a11y.soluteConcentrationsAccordionBox.barChart.accessibleNameNoneStringProperty' );
...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    soluteConcentrationsAccordionBox: {
      ...
      barChart: {
        accessibleNameNone: new FluentPattern<{ soluteType: 'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp' | TReadOnlyProperty<'oxygen' | 'carbonDioxide' | 'sodiumIon' | 'potassiumIon' | 'glucose' | 'atp'> }>( fluentSupport.bundleProperty, 'a11y_soluteConcentrationsAccordionBox_barChart_accessibleNameNone', _.get( MembraneTransportStrings, 'a11y.soluteConcentrationsAccordionBox.barChart.accessibleNameNoneStringProperty' ), [{"name":"soluteType","variants":["oxygen","carbonDioxide","sodiumIon","potassiumIon","glucose","atp"]}] ),
