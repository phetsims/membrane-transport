...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    _comment_1: new FluentComment( {"comment":"accessibleHelpText for the ligand control","associatedKey":"ligandToggleButtonAccessibleHelpText"} ),
    ...
    _comment_2: new FluentComment( {"comment":"Spoken when the ligand is grabbed.","associatedKey":"grabbedLigandResponsePattern"} ),
    ...
    _comment_3: new FluentComment( {"comment":"Transport protein brief names","associatedKey":"transportProteinBriefName"} ),
    ...
    _comment_4: new FluentComment( {"comment":"Spoken when the ligand moves above a protein that can open or close","associatedKey":"ligandMovedAboveLigandGatedChannelPattern"} ),
    ...
    _comment_5: new FluentComment( {"comment":"Spoken when the ligand moves above a protein that cannot open or close (leakage channel).","associatedKey":"ligandMovedAboveLeakageChannelPattern"} ),
    ...
    _comment_6: new FluentComment( {"comment":"Spoken when the ligand moves above any other channel that can open/close, but does not bind to ligands.","associatedKey":"ligandMovedAboveOtherChannelPattern"} ),
    ...
    _comment_7: new FluentComment( {"comment":"Membrane potential change responses for voltage-gated channels","associatedKey":"membranePotentialChanges"} ),
    membranePotentialChanges: {
      ...
      _comment_0: new FluentComment( {"comment":"We like to say opening first, since users are more interested to hear what just opened.","associatedKey":"sodiumClosedPotassiumOpened"} ),
