  ...
  a11y: {
    ...
    transportProteinPanel: {
      ...
      voltageGatedChannelPanel: {
        ...
        _comment_108: new FluentComment( {"comment":"For the Membrane Potential radio buttons","lineNumber":108,"associatedKey":"membranePotential"} ),
        membranePotential: {
          radioButtonGroup: {
    ...
    _comment_141: new FluentComment( {"comment":"Accessible names for solute radio buttons","lineNumber":141,"associatedKey":"soluteAccessibleNames"} ),
    ...
    _comment_267: new FluentComment( {"comment":"accessibleHelpText for the ligand control","lineNumber":267,"associatedKey":"ligandToggleButtonAccessibleHelpText"} ),
    ...
    _comment_272: new FluentComment( {"comment":"Spoken when the ligand is grabbed.","lineNumber":272,"associatedKey":"grabbedLigandResponsePattern"} ),
    ...
    _comment_277: new FluentComment( {"comment":"Transport protein brief names","lineNumber":277,"associatedKey":"transportProteinBriefName"} ),
    ...
    _comment_290: new FluentComment( {"comment":"Spoken when the ligand moves above a protein that can open or close","lineNumber":290,"associatedKey":"ligandMovedAboveLigandGatedChannelPattern"} ),
    ...
    _comment_300: new FluentComment( {"comment":"Spoken when the ligand moves above a protein that cannot open or close (leakage channel).","lineNumber":300,"associatedKey":"ligandMovedAboveLeakageChannelPattern"} ),
    ...
    _comment_303: new FluentComment( {"comment":"Spoken when the ligand moves above any other channel that can open/close, but does not bind to ligands.","lineNumber":303,"associatedKey":"ligandMovedAboveOtherChannelPattern"} ),
    ...
    _comment_310: new FluentComment( {"comment":"Membrane potential change responses for voltage-gated channels","lineNumber":310,"associatedKey":"membranePotentialChanges"} ),
    membranePotentialChanges: {
      ...
      _comment_319: new FluentComment( {"comment":"We like to say opening first, since users are more interested to hear what just opened.","lineNumber":319,"associatedKey":"sodiumClosedPotassiumOpened"} ),
