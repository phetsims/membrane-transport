...
addToMapIfDefined( 'a11y_soluteControl_accessibleObjectResponseAtMax', 'a11y.soluteControl.accessibleObjectResponseAtMaxStringProperty' );
...
addToMapIfDefined( 'a11y_transportProtein_voicingHintResponse_general', 'a11y.transportProtein.voicingHintResponse.generalStringProperty' );
addToMapIfDefined( 'a11y_transportProtein_voicingHintResponse_mouseInputFromToolbox', 'a11y.transportProtein.voicingHintResponse.mouseInputFromToolboxStringProperty' );
addToMapIfDefined( 'a11y_transportProtein_voicingHintResponse_mouseInputFromMembrane', 'a11y.transportProtein.voicingHintResponse.mouseInputFromMembraneStringProperty' );
...
const MembraneTransportFluent = {
  ...
  a11y: {
    ...
    soluteControl: {
      ...
      _comment_1: new FluentComment( {"comment":"A response that is spoken when the solute count is already at the maximum","associatedKey":"accessibleObjectResponseAtMax"} ),
      _comment_2: new FluentComment( {"comment":"and the user tries to add more. It makes it clear that nothing is changing.","associatedKey":"accessibleObjectResponseAtMax"} ),
      accessibleObjectResponseAtMaxStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_soluteControl_accessibleObjectResponseAtMax', _.get( MembraneTransportStrings, 'a11y.soluteControl.accessibleObjectResponseAtMaxStringProperty' ) )
    },
    ...
    transportProtein: {
      ...
      voicingHintResponse: {
        ...
        _comment_2: new FluentComment( {"comment":"Spoken when the protein in the membrane is grabbed with mouse input.","associatedKey":"mouseInputFromMembrane"} ),
        mouseInputFromMembraneStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_transportProtein_voicingHintResponse_mouseInputFromMembrane', _.get( MembraneTransportStrings, 'a11y.transportProtein.voicingHintResponse.mouseInputFromMembraneStringProperty' ) )
      },
