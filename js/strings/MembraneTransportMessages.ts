...
type MembraneTransportFluentType = {
  ...
  'ligandsOnOutsideOnlyMessageProperty': TReadOnlyProperty<string>;
  ...
  'grabbedLigandResponsePatternMessageProperty': LocalizedMessageProperty;
  'grabbedLigandResponseWithHintPatternMessageProperty': LocalizedMessageProperty;
  'grabbedLigandResponseWithEmptyMembraneHintPatternMessageProperty': LocalizedMessageProperty;
  'ligandMovedAboveLigandGatedChannelPatternMessageProperty': LocalizedMessageProperty;
  'ligandMovedAboveLeakageChannelPatternMessageProperty': LocalizedMessageProperty;
  'ligandMovedAboveOtherChannelPatternMessageProperty': LocalizedMessageProperty;
};
